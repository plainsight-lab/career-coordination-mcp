...
// LanceDBEmbeddingIndex is a stub implementation that throws runtime_error.
// LanceDB integration is planned for a future v0.2 slice.
// This stub demonstrates interface extensibility and documents the planned architecture.
